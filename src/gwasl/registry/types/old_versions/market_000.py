...
from gridflo.asl.base import AslType
from gridflo.asl.enums import MarketCategory, MarketPriceUnit, MarketTypeName
from gridflo.asl.property_format import (
    LeftRightDot,
    MarketName,
)
from gridflo.asl.types import Market


class Market000(AslType):
    name: MarketName
