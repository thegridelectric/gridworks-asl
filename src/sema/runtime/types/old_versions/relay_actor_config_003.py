...
class RelayActorConfig003(SemaType):
    ...
    def check_axiom_1(self) -> "RelayActorConfig003":
        """
    ...
    @model_validator(mode="after")
    def check_axiom_2(self) -> "RelayActorConfig003":
        """
    ...
    @model_validator(mode="after")
    def check_axiom_3(self) -> "RelayActorConfig003":
        """
    ...
    @model_validator(mode="after")
    def check_axiom_4(self) -> "RelayActorConfig003":
        """
    ...
    @model_validator(mode="after")
    def check_axiom_5(self) -> "RelayActorConfig003":
        """
