...
class SimPicoTankModuleComponentGt000(SemaType):
    ...
    def check_axiom_1(self) -> "SimPicoTankModuleComponentGt000":
        """
    ...
    @model_validator(mode="after")
    def check_axiom_2(self) -> "SimPicoTankModuleComponentGt000":
        """
    ...
    @model_validator(mode="after")
    def check_axiom_3(self) -> "SimPicoTankModuleComponentGt000":
        """
    ...
    def upgrade(self) -> SimPicoTankModuleComponentGt:
        ...
        raise SemaType.upgrade_requires_context(
            ...
            "SimPicoTankModuleComponentGt without the source layout "
