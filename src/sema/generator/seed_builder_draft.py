...
class SeedBuilder:
    ...
    def _copy_types(self, types_dir: Path):
        ...
        for type_name in self.resolved_types:
            ...
            if source.exists():
                ...
                # Rewrite imports from sema.registry to target package
    ...
    def _rewrite_imports(self, content: str, package_name: str) -> str:
        ...
        # Replace imports from sema.registry.types
        content = re.sub(
        ...
        # Replace imports from sema.registry.enums
        content = re.sub(
        ...
        # Replace imports from sema.registry (for semaType base class)
        content = re.sub(
