...
', 'Logical', 'active', '2026-02-22T16:43:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Normal', 'active', '2026-03-16T14:14:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'WallThermostat', 'active', '2026-03-27T21:31:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'OpenRelay', 'active', '2024-09-17T20:17:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Denied', 'active', '2026-03-16T14:14:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'SecurityViolation', 'active', '2026-03-16T14:14:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Other', 'active', '2024-10-08T17:17:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Active', 'active', '2026-03-04T17:00:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'RabbitAmqp', 'active', '2026-03-03T17:00:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Pending', 'active', '2026-02-22T16:43:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Constant', 'active', '2024-10-23T19:32:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Unknown', 'active', '2026-02-23T17:08:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'NoActor', 'active', '2026-01-15T18:00:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'NoActor', 'active', '2026-02-17T20:00:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'NoActor', 'active', '2026-02-18T21:34:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'OnTrigger', 'active', '2026-02-02T22:17:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'DigitalZeroIsActive', 'active', '2026-03-16T14:14:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Unknown', 'active', '2026-02-17T19:54:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Unknown', 'active', '2026-03-31T09:18:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'AllTanks', 'active', '2026-01-14T18:04:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Heating', 'active', '2026-01-14T18:04:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Unknown', 'active', '2025-12-25T22:18:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Unknown', 'active', '2026-03-04T20:35:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'BasicExpWeightedAvg', 'active', '2024-10-23T19:32:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'USDPerMWh', 'active', '2024-12-05T19:25:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'AvgMW', 'active', '2024-12-05T19:25:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;

INSERT INTO enum_versions (enum_versions_id, enum, version, schema_url, title, description, default_symbol, status, created, raw_json)
VALUES ('84d73a22-acb8-4bf3-fd29-9ea49923b210', 'market.type.name', '000', 'https://schemas.electricity.works/enums/market.type.name/000', 'market.type.name', 'Categorizes different markets run by MarketMaker', 'unknown', 'active', '2022-10-17T16:55:39Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'RelayClosed', 'active', '2024-09-17T20:17:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', '0', 'active', '2024-03-06T22:07:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
patterns.
', 'RelayClosed', 'active', '2025-10-14T16:07:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'NormallyClosed', 'active', '2024-09-17T19:18:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'UnknownMake__UnknownModel', 'active', '2024-10-18T15:21:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'UnknownMake__UnknownModel', 'active', '2026-01-03T14:27:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'Unknown', 'active', '2025-09-24T14:28:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
Newer Sema vocabulary separates quantity classification (gw1.quantity) from unit representation (gw1.unit) to make dimensional semantics explicit and mechanically verifiable. Future designs SHOULD prefer those explicit fields over introducing new values into this enum.
This enum remains authoritative for existing Spaceheat channel definitions but is not intended to expand indefinitely.
', 'Unknown', 'active', '2026-03-30T17:12:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', 'SimpleBeta', 'active', '2024-10-21T23:19:00Z', NULL) ON CONFLICT (enum_versions_id) DO NOTHING;
...
', TRUE, 'active', '2024-10-06T17:49:32Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', TRUE, 'active', '2024-10-08T17:17:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', TRUE, 'active', '2025-04-23T18:03:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', TRUE, 'active', '2024-10-08T17:41:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', NULL, '{"IsVersionless": true}') ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2025-12-25T22:18:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-03-16T14:14:56Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-03-31T09:18:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-02-25T14:23:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', TRUE, 'active', '2024-12-31T15:42:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', TRUE, 'active', '2026-01-28T15:17:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
This includes relay-actor configuration fields specific to the I2C relay board together with the logical I2C bus name used to address it at runtime.
', TRUE, 'active', '2026-04-01T10:49:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-03-30T16:07:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-02-06T17:06:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2024-11-09T16:36:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2024-10-23T19:32:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', TRUE, 'active', '2025-12-05T02:59:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2022-10-17T16:55:39Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2025-10-30T17:29:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2025-04-23T18:03:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-03-30T19:01:47Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-03-02T18:00:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-03-02T18:15:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2024-12-09T15:00:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-03-02T17:00:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', TRUE, 'active', '2026-01-03T14:27:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-03-30T17:12:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
...
', FALSE, 'active', '2026-03-30T00:00:00Z', NULL) ON CONFLICT (type_versions_id) DO NOTHING;
